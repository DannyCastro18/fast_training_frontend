...
const NavbarEntrenador = () => {
  return (
    <nav className="bg-white w-20 fixed h-screen m-4 max-h-[calc(100vh-2rem)] border-2 border-blue-900 flex flex-col items-center shadow-[6px_0_18px_rgba(0,0,0,0.1)] dark:shadow-[8px_0_20px_rgba(0,0,0,0.5)] py-7 transition-all rounded-2xl overflow-y-auto z-1">
      <div className="flex flex-col items-center space-y-9 mt-4 flex-1">
        ...
        <Link href="/entrenador/ingresoDatos" className="mt-auto">
