...
//     try {
//       const response = await axios.post('http://localhost:5000/api/equipos', {
//         teamName,
//         description
//       });
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-200 bg-opacity-20 p-4">
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <label className="cursor-pointer flex flex-col items-center">
            {teamImagePreview ? (
              <img src={teamImagePreview} alt="Escudo del equipo" className="w-24 h-24 rounded-full object-cover border-2 border-gray-300 shadow-lg" />
            ) : (
              <motion.div 
                whileHover={{ scale: 1.1 }} 
                className="w-24 h-24 bg-gray-200 flex items-center justify-center rounded-full text-gray-500 shadow-md"
